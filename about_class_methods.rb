...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_you_can_define_methods_on_individual_objects
    ...
    assert_equal :fidos_wag, fido.wag # defined on the instance var named fido
  end
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal nil, Dog.name # because name has no default value
  end
  ...
  # if you have multiple class methods to define, you can put them all
  # inside class << self to avoid duplucating them with "self." prefix
  # ------------------------------------------------------------------
