...
class AboutClasses < EdgeCase::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name("Fido") # sets the @name instance var
    assert_equal [:@name], fido.instance_variables # the instance var name, symbolized
  end
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # => there is no parameterless constructor and the
    # => initial_name arg doesn't have a default value
  end
