...
class AboutMethods < EdgeCase::Koan
  ...
  def test_calling_with_variable_arguments
    assert_equal [], method_with_var_args # *args returns an empty array if no args sent
  ...
  def test_method_with_explicit_return
    assert_equal :return_value, method_with_explicit_return # return terminates immediately
  end
  ...
  def test_method_without_explicit_return
    assert_equal :return_value, method_without_explicit_return # last value is implicitly returned
  end
