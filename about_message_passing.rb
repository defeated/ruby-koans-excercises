...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # => because send() is a common method and could be overridden
    # => by the author?
    # => and what if you needed to send(:send)
  end
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    assert_equal false, catcher.respond_to?(:any_method) # method_missing affects respond_to
  end
